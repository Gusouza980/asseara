        ...
        <div>
            <div class="container-fluid p-0">
                <div class="row g-0">
                    ...
                    <div class="col-xl-9" style="background: url(/admin/images/banner-login.jpg); background-size: cover; background-position:center;">
                    ...
                    <div class="col-xl-3" style="background-color: #0098DA;">
                            ...
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="mt-4">
                                            <form action="{{route('painel.logar')}}" method="post">
                                                ...
                                                <div class="mt-3 d-grid">
                                                    <button class="btn waves-effect waves-light" style="background-color: #F2F2F2;" type="submit">Entrar</button>
                                                </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center text-white">
                                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Asseara</p>
                                    </div>
                                </div>
