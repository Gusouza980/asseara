...
<body>
    ...
    <div style="text-align:center; font-family: Calibri, sans-serif; font-size: 25px; font-weight: bold; position: absolute; top: 80px; left: 0px; height: 60px; width: 70%; border: 1px solid #D6D6D6;">
        <span style="font-family: Calibri, sans-serif; font-size: 19px; font-weight: bold; position: absolute; top: 8px; left: 70px;">04 - Observações e Determinações do Profissional</span>
    </div>
    ...
    <span style="font-family: Calibri, sans-serif;position: absolute; top: 1020px; right: 0; font-size: 11px;">Página 6 / 12</span>
